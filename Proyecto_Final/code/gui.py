...
class Admin_window(Frame):
    def __init__(self, root):
        ...
        registerBoxbtn.place(x=125, y= 230, width=150, height=50)
        ...
        makeReportbtn.place(x=125, y= 300, width=150, height=50)

        newProductbtn = Button(frame,command=self.gotoPriviliges, text="Dar Privilegios",font =("calibri", 15, "bold"), bd=3, relief=RIDGE, fg="white", bg="lightseagreen")
        newProductbtn.place(x=325, y= 230, width=150, height=50)
        ...
        newProductbtn.place(x=325, y= 300, width=150, height=50)
...
class RegisterBox_window(Frame):
    def __init__(self, root):
        ...
        cajaStorebtn.place(x=125, y= 230, width=150, height=50)

        pedidosbtn = Button(frame,command=self.gotoPedidos, text="Hacer Pedidos",font =("calibri", 15, "bold"), bd=3, relief=RIDGE, fg="white", bg="lightseagreen")
        pedidosbtn.place(x=125, y= 300, width=150, height=50)
        ...
        extraIngbtn.place(x=325, y= 230, width=150, height=50)
        ...
        extraGastbtn.place(x=325, y= 300, width=150, height=50)
